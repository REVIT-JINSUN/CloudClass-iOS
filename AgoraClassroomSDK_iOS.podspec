Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/AgoraIO-Community/CloudClass-iOS.git", :tag => "AgoraClassroomSDK_iOS_v" + "#{spec.version.to_s}" }

  spec.platform              = :ios
  spec.ios.deployment_target = "10.0"
  
  # open source libs
  spec.dependency "AgoraEduUI",   "~> 2.8.110"
  
  # open sources widgets
  spec.dependency "AgoraWidgets", "~> 2.8.110"
